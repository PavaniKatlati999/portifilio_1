    ...
    projects: [
      {
        ...
        link: 'https://www.behance.net/gallery/219567089/Food-Website-Design',
      },
      {
        image: websiteImg2,
        title: 'Staff Sync ',
        description: 'A food e-commerce website like Swiggy, built with Angular & .NET.',
        link: 'https://www.behance.net/gallery/220789573/Staff-Sync-Case-Study',
      },
      {
        image: websiteImg3,
        title: 'Stylum ',
        description: 'A basic blog website built with Next.js and MongoDB.',
        link: 'https://www.behance.net/gallery/220703101/STYLUM-A-Modern-Approach-to-Fashion-Branding',
      },
      {
        image: websiteImg4,
        title: 'Pop - Up Design',
        description: 'An Ecommerce Website built with the MERN Stack.',
        link: 'https://www.behance.net/gallery/216703423/Popup-Design-Gallery',
      },
      {
        image: websiteImg5,
        title: 'Infographic ',
        description: 'A food e-commerce website like Swiggy, built with Angular & .NET.',
        link: 'https://www.behance.net/gallery/217625195/Futuristic-technology-infographic',
      },
      {
        image: websiteImg6,
        title: 'Icon Style Collection',
        description: 'A basic blog website built with Next.js and MongoDB.',
        link: 'https://www.behance.net/gallery/215391675/Icons',
      },
